...
public class DancingLettersActivity extends DinjaActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Quat4f letterRotation = new Quat4f(0, 0, -0.15f, 1);
		...
		registerController(new UpperLetterAnimator(letterD, new Quat4f(0, 0, 0.15f, 1), 1.5f));
		registerController(new UpperLetterAnimator(letterI, new Quat4f(0, 0, 0.15f, 1), 1.525f));
		registerController(new UpperLetterAnimator(letterN, new Quat4f(0, 0, 0.15f, 1), 1.55f));
		registerController(new UpperLetterAnimator(letterJ, new Quat4f(0, 0, 0.15f, 1), 1.575f));
		registerController(new UpperLetterAnimator(letterA, new Quat4f(0, 0, 0.15f, 1), 1.6f));
	...
	private class UpperLetterAnimator extends LoopAnimatorScript {
		public UpperLetterAnimator(DancingLetter letter, Quat4f rotation, float duration) {
	...
	private class DancingLetter extends Plane {
		...
		public DancingLetter(String name, String textureName, float x, float y, float width, float height, Quat4f rotation) {
